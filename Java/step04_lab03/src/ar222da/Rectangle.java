...
public class Rectangle 
{
	 ...
	 * 
	 * @param width sätter privata fältet width
	 * @param height sätter privata fältet height
	 */
	...
	/** Konstruktor för klassen som används om man ännu inte vet rektangelns höjd och bredd. */
	public Rectangle()
	{
		this(0,0);
	}
	...
	/** Returnerar resultat av privata fälten och areaberäkning som en sträng
	 * 
	 */
	@Override
	public String toString() {
		return String.format("En rektangel med bredden %d och höjden %d.\nArean beräknas nu till: %d", width, height, this.computeArea());
	}
